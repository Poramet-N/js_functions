...
function getTruckName(truck) {
  return truck.name; // TODO: your code here
}
...
function isTruckOpen(truck) {
  return truck.isOpen; // TODO: your code here
}
...
function getDailySalesTarget(truck) {
  return truck.dailySalesTarget; // TODO: your code here
}
...
function describeTruck(truck) {
  return `${truck.name} is located in ${truck.location}.`; // TODO: your code here
}
