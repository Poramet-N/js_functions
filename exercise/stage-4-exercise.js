...
function getUnavailableItems(items) {
  return items.filter(item => !item.isAvailable); // TODO: your code here
}
...
function getAffordableItems(items) {
  return items.filter(item => item.price < 200); // TODO: your code here
}
...
function getLowStockItems(items) {
  return items.filter(item => item.stock < 10); // TODO: your code here
}
...
function getCompletedOrders(orderList) {
   return orderList.filter(order => order.status === "completed"); // TODO: your code here
}
...
function getAvailableBurgers(items) {
   return items.filter(item => item.category === "burger" && item.isAvailable); // TODO: your code here
}
...
function getBurgersWithinBudget(items, maximumPrice) {
   return items.filter(item => item.category === "burger" && item.price <= maximumPrice); // TODO: your code here
}
