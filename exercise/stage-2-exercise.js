...
function countMenuItems(items) {
   return items.length; // TODO: your code here
}
...
function getFirstMenuItem(items) {
  return items[0]; // TODO: your code here
}
...
function getFirstItemName(items) {
   return items[0].name; // TODO: your code here
}
...
function getLastMenuItem(items) {
    return items[items.length - 1]; // TODO: your code here
}
...
function getLastItemPrice(items) {
   return items[items.length - 1].price; // TODO: your code here
}
